...
rm -f build/sample_macho.o build/sample_elf.o build/bslash.bin build/bslash.bas.bin build/bslash_elf.o build/bslash_macho.o build/bslash_incbin.bin
...
./build/chs --arch bslash --format bin --output build/bslash_incbin.bin tests/bslash_incbin.bas

test -s build/sample_macho.o
test -s build/sample_elf.o
cmp -s build/bslash.bin build/bslash.bas.bin
cmp -s build/bslash_incbin.bin tests/incbin_payload.bin
